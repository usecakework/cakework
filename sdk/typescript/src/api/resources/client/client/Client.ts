...
export class Client {
  ...
  public async getRunStatus(
    ...
    request: CakeworkApi.RunStatusRequest
  ): Promise<CakeworkApi.Status> {
    const _queryParams = new URLSearchParams();
    _queryParams.append("token", request.token);
  ...
  public async getRunResult(
    runId: CakeworkApi.RunId,
    request: CakeworkApi.RunResultRequest
  ...
  public async run(
    ...
    const _response = await core.fetcher({
      ...
      method: "POST",
      queryParameters: _queryParams,
      body: await serializers.RunRequestBody.json(request.body),
    });
    if (_response.ok) {
